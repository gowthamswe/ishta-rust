...
pub fn __preserve_no_mangle_symbols() -> usize {
    ...
    keep!(
        ...
        lazy::karac_lazy_expr_desc,
        lazy::karac_lazy_expr_agg,
        lazy::karac_lazy_expr_alias,
        ...
        lazy::karac_lazy_sort,
        lazy::karac_lazy_group_by,
        lazy::karac_lazy_agg,
        lazy::karac_lazy_join,
        lazy::karac_lazy_with_columns,
        lazy::karac_lazy_explain,
        lazy::karac_lazy_collect,
        lazy::karac_lazy_retain,
        lazy::karac_lazy_release,
        lazy::karac_lazy_gb_retain,
        lazy::karac_lazy_gb_release,
    );
    ...
    #[cfg(feature = "arrow")]
    keep!(arrow_ipc::karac_arrow_tensor_from_ipc);
